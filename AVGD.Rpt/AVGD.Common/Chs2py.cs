...
namespace AVGD.Common
{
    ...
    public class Chs2py
    {
        ...
        /// 难检字码表． 
        /// </summary> 
        private static string sCodeData = "";
        #endregion
        ...
        {
            string pinyin = Chs2py.GetFullChs2Py(c.ToString());
            char result;
            if (!string.IsNullOrEmpty(pinyin))
            {
                result = pinyin.ToUpper()[0];
            }
            else
            {
                result = ' ';
        ...
        public static char GetFirstPyChar(string strName)
        {
            ...
            {
                result = Chs2py.GetFirstPyChar(strName[0]);
            }
            else
            {
                result = ' ';
        ...
        /// <returns></returns>
        public static string GetFirstPyString(string strName)
        {
            ...
            if (!string.IsNullOrEmpty(strName))
            {
                ...
                {
                    char item = strName[i];
                    py += Chs2py.GetFirstPyChar(item).ToString();
                }
            }
            return py.ToLower();
        }
        ...
        public static short GetGB2312Code(string s)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (arBytes.Length < 2)
                    {
                        result = (short)arBytes[0];
                    }
                    else
                    {
                        result = (short)((int)arBytes[0] << 8 | (int)arBytes[1]);
                    }
                }
            }
            return result;
        ...
        {
            return Chs2py.GetGB2312Code(string.Concat(c));
        }
        ...
        public static string GetFullChs2Py(string chineseString)
        {
            ...
            {
                if (regex.IsMatch(noWChar[i].ToString()))
                {
                    array = Encoding.Default.GetBytes(noWChar[i].ToString());
                    int i2 = (int)array[0];
                    int i3 = (int)array[1];
                    int chrAsc = i2 * 256 + i3 - 65536;
                    ...
                    {
                        for (int j = Chs2py.pyvalue.Length - 1; j >= 0; j--)
                        {
                            if (Chs2py.pyvalue[j] <= chrAsc)
                            {
                                pyString += Chs2py.pystr[j];
                                break;
                            }
                        }
                    }
    ...
    public class PinYin
    {
        public static string GetFirstLetter(string hz)
        {
         ...
         "鳕鳗鳘鳙鳜鳝鳟鳢靼鞅鞑鞒鞔鞯鞫鞣鞲鞴骱骰骷鹘骶骺骼髁髀髅髂髋髌髑魅魃魇魉魈魍魑飨餍餮饕饔髟髡髦髯髫髻髭髹鬈鬏鬓鬟鬣麽麾縻麂麇麈麋麒鏖麝麟黛黜黝黠黟黢黩黧黥黪黯鼢鼬鼯鼹鼷鼽鼾齄";
            ...
            {
                array = System.Text.Encoding.Default.GetBytes(hz.ToString());
                ...
                else if (array[0] >= 176 && array[0] <= 215)
                {
                    ...
                    if (hz.ToString().CompareTo("匝") >= 0)
                        return_py += "z";
                    else if (hz.ToString().CompareTo("压") >= 0)
                        return_py += "y";
                    else if (hz.ToString().CompareTo("昔") >= 0)
                        return_py += "x";
                    else if (hz.ToString().CompareTo("哇") >= 0)
                        return_py += "w";
                    else if (hz.ToString().CompareTo("塌") >= 0)
                        return_py += "t";
                    else if (hz.ToString().CompareTo("撒") >= 0)
                        return_py += "s";
                    else if (hz.ToString().CompareTo("然") >= 0)
                        return_py += "r";
                    else if (hz.ToString().CompareTo("期") >= 0)
                        return_py += "q";
                    else if (hz.ToString().CompareTo("啪") >= 0)
                        return_py += "p";
                    else if (hz.ToString().CompareTo("哦") >= 0)
                        return_py += "o";
                    else if (hz.ToString().CompareTo("拿") >= 0)
                        return_py += "n";
                    else if (hz.ToString().CompareTo("妈") >= 0)
                        return_py += "m";
                    else if (hz.ToString().CompareTo("垃") >= 0)
                        return_py += "l";
                    else if (hz.ToString().CompareTo("喀") >= 0)
                        return_py += "k";
                    else if (hz.ToString().CompareTo("击") >= 0)
                        return_py += "j";
                    else if (hz.ToString().CompareTo("哈") >= 0)
                        return_py += "h";
                    else if (hz.ToString().CompareTo("噶") >= 0)
                        return_py += "g";
                    else if (hz.ToString().CompareTo("发") >= 0)
                        return_py += "f";
                    else if (hz.ToString().CompareTo("蛾") >= 0)
                        return_py += "e";
                    else if (hz.ToString().CompareTo("搭") >= 0)
                        return_py += "d";
                    else if (hz.ToString().CompareTo("擦") >= 0)
                        return_py += "c";
                    else if (hz.ToString().CompareTo("芭") >= 0)
                        return_py += "b";
                    else if (hz.ToString().CompareTo("啊") >= 0)
                        return_py += "a";
                }
                //二级汉字
                else if (array[0] >= 215)
                {
                    return_py += ls_second_eng.Substring(ls_second_ch.IndexOf(hz.ToString(), 0), 1);
                }
            }
